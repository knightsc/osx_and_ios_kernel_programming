...
int main (int argc, const char *argv[])
{
    ...
    // The USB Vendor ID 0x05AC and Product ID 0x8600 corresponds to a particular model of FaceTime camera.
    //
    // NOTE: On modern macOS systems the com.apple.ibridge.control entitlement is needed to access the built in camera.
    // The vendor ID / product ID can be changed to any device that is present on your system.
    matchingDictionary = MyCreateUSBMatchingDictionary(0x05AC, 0x8600);
