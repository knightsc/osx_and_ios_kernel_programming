...
protected:
    ...
    static IOReturn sStartTimer(OSObject *target, void *reference, IOExternalMethodArguments *args);
    static IOReturn sStopTimer(OSObject *target, void *reference, IOExternalMethodArguments *args);
    static IOReturn sGetElapsedTimerTime(OSObject *target, void *reference, IOExternalMethodArguments *args);
    static IOReturn sGetElapsedTimerValue(OSObject *target, void *reference, IOExternalMethodArguments *args);
    static IOReturn sDelayForMs(OSObject *target, void *reference, IOExternalMethodArguments *args);
    static IOReturn sDelayForTime(OSObject *target, void *reference, IOExternalMethodArguments *args);
};
